...
function TheGymArchitecture() {
	...
	//a.rotate(-30);
	allThings[p++] = a;
	a= new Arrow("6. BPM", 0xFF000000, 180);
	a.scale(s*0.35, s*0.8);
	a.translate(128*s, -138*s);
	a.rotate(135);
	allThings[p++] = a;
	a= new Arrow("7. BPM", 0xFF000000, 180);
	a.scale(s*0.18, s*0.8);
	a.translate(148*s, -280*s);
	a.rotate(0);
	allThings[p++] = a;
	a= new Arrow("8. BPM", 0xFF000000, 180);
	a.scale(s*0.75, s*0.8);
	a.translate(-230*s, -280*s);
	a.rotate(180);
	allThings[p++] = a;
	a= new Arrow("9. BPM", 0xFF000000, 180);
	a.scale(s*0.24, s*0.8);
	a.translate(332*s, 0*s);
	a.rotate(0);
	allThings[p++] = a;
	a= new Arrow("10. BPM", 0xFF000000, 180);
	a.scale(s*0.24, s*0.8);
	a.translate(620*s, 0*s);
	a.rotate(0);
	allThings[p++] = a;
	...
	let kafka= new MicroserviceThing("images/kafka.png", "", "Kafka", sx+1.5*dx, 0, s, 120, 120);
	let kafkaconnect= new MicroserviceThing("images/kafka.png", "", "Kafka Connect", sx+3*dx, 0, s, 120, 120);
	...
	let elastic= new MicroserviceThing("images/elastic.png", "", "Elastic", sx+4.5*dx, 0, s, 120, 120);
	...
	for ( var layer = 0; layer < 1000; layer++) {
		...
		pos += kafka.addThings(allThings, pos, layer);
		pos += kafkaconnect.addThings(allThings, pos, layer);
		...
		pos += elastic.addThings(allThings, pos, layer);
